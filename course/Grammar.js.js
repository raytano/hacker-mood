...
let questions = [
  ...
  new Question(" Her and I.....Rice", ["eat","Are eat", "am eat", "eating"], "eat"),
  new Question("He......his work", ["Show ", "Is show", "Shows", "Had show"], "Shows"),
  new Question("<< ....a footballer? >>", ["is","are", "Do", "Is"], "Is"),
  ...
  new Question("<< .....He do the text >> ?", ["Is","Does", "have", "Weill"], "Is"),
  new Question("<<......I go to school>> ", ["Does","Do", "Am", "Have"], "Do"),
  ...
  new Question("He........His eyes are open", ["Not sleep","Doesn't sleep", "Isn't sleep", "Are't sleep"], "Doesn't sleep"),
  ...
  new Question("<< George....well when he is not tired (WORK) >>", ["Work","has work", "workes", "works"], "works"),
  ...
  new Question("he.....walk to school now?", ["To be walk","Is walk", " is walking", "has walked"], "is walking"),
